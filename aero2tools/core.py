...
class Config:
    ...
    def __init__(self):
        ...
        self.ur.formatter.default_format = ".3f~P"
...
class optimize:
    ...
    def diff2(func, x):
        ...
        f1 = optimize.diff(func, x)
        f2 = optimize.diff(func, x + optimize.h)
        
        return (f2 - f1) / optimize.h

    def optimize(func, init):
        
        xN = init
        
        for j in range(20):
            d1 = optimize.diff(func, xN)
            d2 = optimize.diff2(func, xN)
    ...
    def target(func, init, targ):
        
        xN = init
        
        for j in range(20):
            f = func(xN)
            d = optimize.diff(func, xN)
